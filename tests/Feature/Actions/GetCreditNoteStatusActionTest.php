...
it('gets credit note status successfully', function () {
    Http::fake([
...
it('gets credit note status with numeric id', function () {
    Http::fake([
...
it('handles different credit note statuses', function (string $status) {
    Http::fake([
        'api.example.com/api/invoices/123/status' => Http::response([
            'invoice' => [
                'id' => 123,
